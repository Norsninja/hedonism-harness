...
6. `test_distance_uses_per_tick_lineage_mean_then_mean_over_ticks` — synthetic capture: tick 0 has 1 agent at distance 9 (per_tick mean = 9); tick 1 has 3 agents at distances (1, 1, 1) (per_tick mean = 1); ticks 2..50 have 0 living agents; assert observable = mean(9, 1) = 5.0. Agent-tick pooling would yield mean(9, 1, 1, 1) = 3.0 — the test fails under that incorrect aggregation, distinguishing the two rules.
