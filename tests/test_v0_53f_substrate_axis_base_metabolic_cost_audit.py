"""v0.53f substrate-axis disambiguation audit (base_metabolic_cost=0.10 tick-200) — tests.

16 locked tests. Pre-reg: [[docs/experiments/fear_hunger_v0.53f.md]] §"Test
...
_SCRIPT_PATH = (
    Path(__file__).parent.parent / "scripts" / "v0_53f_substrate_axis_base_metabolic_cost_audit.py"
)
_spec = importlib.util.spec_from_file_location("v0_53f_audit", _SCRIPT_PATH)
assert _spec is not None
assert _spec.loader is not None
v0_53f_audit = importlib.util.module_from_spec(_spec)
sys.modules["v0_53f_audit"] = v0_53f_audit
_spec.loader.exec_module(v0_53f_audit)
...
def _make_summary(
    *,
    ...
    fires_expected = (not math.isnan(signed)) and signed >= v0_53f_audit.COHENS_D_THRESHOLD
    fires_wrong = (not math.isnan(signed)) and signed <= -v0_53f_audit.COHENS_D_THRESHOLD
    return v0_53f_audit.ObservableSummary(
        arm=arm,
...
def _three_summaries_for_arm_tick200(
    ...
    obs = v0_53f_audit.PRIMARY_OBSERVABLES_TICK200
    return [
...
def _zero_drift_bridge_re_anchor() -> list[object]:
    return [
        v0_53f_audit.BridgeReAnchorRow(
            label=label,
            observable=obs,
        ...
        for (label, obs), ref in v0_53f_audit.V048_PUBLISHED_SIGNED_D.items()
    ]
...
def _arm_subverdict_for_tick200(arm: str, kind: str) -> str:
    ...
    table = {
        v0_53f_audit.ARM_A_NULL_V025: {
            "PRESENT": v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
            "PARTIAL": v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PARTIAL,
            "NOT_FOUND": v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_NOT_FOUND,
            "OPPOSITE": v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_OPPOSITE,
        },
        v0_53f_audit.ARM_B_WIDENED_V025: {
            "PRESENT": v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_PRESENT,
            "PARTIAL": v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_PARTIAL,
            "NOT_FOUND": v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
            "OPPOSITE": v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_OPPOSITE,
        },
        v0_53f_audit.ARM_C_WIDENED_METABOLIC_010: {
            "PRESENT": v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
            "PARTIAL": v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PARTIAL,
            "NOT_FOUND": v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_NOT_FOUND,
            "OPPOSITE": v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_OPPOSITE,
        },
    }
...
def test_paired_d_function_reproduces_hand_computed_signed_d_on_fixture_and_tier1_constants_match_v048_published_values():  # noqa: E501
    ...
    derived_d = v0_53f_audit._paired_cohens_d(deltas)
    ...
    assert pinned_v048 == v0_53f_audit.V048_PUBLISHED_SIGNED_D
...
def test_a_null_v025_corpus_a_share_h8_re_anchors_v042_v044_v045():
    clean = [
        v0_53f_audit.ReAnchorRow(
            arm=v0_53f_audit.ARM_A_NULL_V025,
            version=ver,
            hazard=8,
    ...
    rollup, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
        ...
        c_widened_metabolic_010_reachability_tick200=0.50,
    )
    assert rollup == v0_53f_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_BASE_METABOLIC_COST_010

    # Drift > 1e-3 on v0.44 -> CORPUS_REDERIVE_DRIFT_HALT.
    drifted = list(clean)
    drifted[1] = v0_53f_audit.ReAnchorRow(
        arm=v0_53f_audit.ARM_A_NULL_V025,
        version="v0.44",
        hazard=8,
        n_runs_contributing=8,
    ...
    rollup_d, phrase_d = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
    ...
    assert rollup_d == v0_53f_audit.ROLLUP_CORPUS_DRIFT_HALT
...
def test_arm_a_null_v025_uses_tight_gradient_layout_and_default_body_config():
    layout = v0_53f_audit._layout_for_arm(v0_53f_audit.ARM_A_NULL_V025)
    ...
    assert v0_53f_audit.LAYOUT_NAME_BY_ARM[v0_53f_audit.ARM_A_NULL_V025] == "tight_gradient"
    # body_config = None on A (default BodyConfig fallback in run_chamber).
    assert v0_53f_audit._body_config_for_arm(v0_53f_audit.ARM_A_NULL_V025) is None
    assert (
        v0_53f_audit.BODY_BASE_METABOLIC_COST_BY_ARM[v0_53f_audit.ARM_A_NULL_V025]
        == v0_53f_audit.V0_25_BODY_BASE_METABOLIC_COST
        == 0.25
    )
...
def test_arm_b_widened_v025_uses_widened_gradient_layout_and_default_body_config():
    layout = v0_53f_audit._layout_for_arm(v0_53f_audit.ARM_B_WIDENED_V025)
    ...
    assert layout.resolved_spawn_x == 1
    assert v0_53f_audit.LAYOUT_NAME_BY_ARM[v0_53f_audit.ARM_B_WIDENED_V025] == "widened_gradient"
    # body_config = None on B (default BodyConfig fallback in run_chamber).
    assert v0_53f_audit._body_config_for_arm(v0_53f_audit.ARM_B_WIDENED_V025) is None
    assert (
        v0_53f_audit.BODY_BASE_METABOLIC_COST_BY_ARM[v0_53f_audit.ARM_B_WIDENED_V025]
        == v0_53f_audit.V0_25_BODY_BASE_METABOLIC_COST
        == 0.25
    )
...
# and C founder body metabolic-cost at tick-0. Read-only via setup_observer
# snapshot. v0.53e's starting_energy override is NOT carried forward — both B
# and C founders should observe energy=60.0 (V0_25 baseline); only
# base_metabolic_cost differs (0.25 on B; 0.10 on C).
# ---------------------------------------------------------------------------


def test_arm_c_widened_metabolic_010_seam_differentiates_b_and_c_body_metabolic_cost_at_tick_0(
    tmp_path,
):
    # ---- Pre-reg constants (verify before runtime).
    # C arm body_config: base_metabolic_cost=0.10; all other BodyConfig fields default.
    bc_c = v0_53f_audit._body_config_for_arm(v0_53f_audit.ARM_C_WIDENED_METABOLIC_010)
    assert isinstance(bc_c, BodyConfig)
    assert bc_c.base_metabolic_cost == 0.10
    # All other BodyConfig fields preserved at default — including
    # starting_energy=60.0 (v0.53e's 100 is NOT carried forward).
    bc_default = BodyConfig()
    assert bc_c.max_energy == bc_default.max_energy == 100.0
    assert bc_c.starting_energy == bc_default.starting_energy == 60.0
    ...
    # The base_metabolic_cost=0.10 dose constant is locked.
    assert v0_53f_audit.BASE_METABOLIC_COST_010_DOSE == 0.10

    # No other WorldConfig knob differs from V0_25 baseline on C.
    base_arm = v0_53f_audit._select_a_null_arm("v0.42", 0)
    assert base_arm.ambient_influx_rate == v0_53f_audit.V0_25_AMBIENT_INFLUX_RATE == 1.0
    assert base_arm.energy_pool_initial == v0_53f_audit.V0_25_ENERGY_POOL_INITIAL == 1500.0
    assert base_arm.food_respawn_cooldown == v0_53f_audit.V0_25_FOOD_RESPAWN_COOLDOWN == 50

    # ---- Runtime: same (version, seed, hazard); B founder
    # base_metabolic_cost=0.25, C founder base_metabolic_cost=0.10; both arms
    # observe energy=60.0 at tick-0; layouts identical (widened_gradient).
    seed = 41
    cap_b = v0_53f_audit._run_one_arm(
        arm=v0_53f_audit.ARM_B_WIDENED_V025,
        version="v0.42",
        seed=seed,
        hazard=0,
        runs_root=tmp_path,
    )
    cap_c = v0_53f_audit._run_one_arm(
        arm=v0_53f_audit.ARM_C_WIDENED_METABOLIC_010,
        version="v0.42",
        seed=seed,
        hazard=0,
        runs_root=tmp_path,
    ...
    # Founder body energy at tick-0: B = 60.0 AND C = 60.0 (V0_25 baseline preserved).
    ...
    for rec in cap_c.founder_records:
        assert rec.founder_body_energy_tick0 == 60.0, (
            ...
            f"expected 60.0 (V0_25 baseline preserved), got "
    ...
    assert (
        v0_53f_audit.BODY_BASE_METABOLIC_COST_BY_ARM[v0_53f_audit.ARM_C_WIDENED_METABOLIC_010]
        == 0.10
    )
...
def test_founder_traits_byte_identical_across_arms_for_same_seed(tmp_path):
    ...
    for arm in v0_53f_audit.ARMS:
        cap = v0_53f_audit._run_one_arm(
...
def test_founder_positions_byte_identical_across_arms_for_same_seed():
    ...
    expected_ys = None
    for arm in v0_53f_audit.ARMS:
        layout = v0_53f_audit._layout_for_arm(arm)
        spawn_x = layout.resolved_spawn_x
        ys = spread_y(v0_53f_audit.N_FOUNDERS, layout.height)
...
# body_config seam. v0.53f exercises the seam without modification — the
...
# Bookkeeping only — v0.53f's verdict / anchor / locked phrases are not changed.
...
def test_no_src_modifications_compared_to_v0_53e_tip():
    ...
    for rel_path, expected_hash in V052B_TIP_SHA256.items():
        ...
        if actual_hash != expected_hash:
            raise AssertionError(
                "v0.53f is pre-registered to leave the science-core five files "
    ...
    if actual_chamber_hash != V053E_CHAMBER_DRIVER_SHA256:
        raise AssertionError(
            "v0.53f is pre-registered to leave the chamber driver byte-identical "
...
def test_label_a_high_sensor_radius_lineage_picks_correct_lineage():
    ...
    label = v0_53f_audit._select_sensor_radius_label(sensor_radius_by_lineage)
    assert label == 4

    # Tiebreak min(lineage_id) on ties.
    sensor_tied = {0: 6, 1: 5, 2: 6, 3: 6, 4: 4}
    label_tied = v0_53f_audit._select_sensor_radius_label(sensor_tied)
    assert label_tied == 0
...
def test_label_b_three_variants_three_tier_tiebreak_at_each_window():
    ...
    assert v0_53f_audit._select_fraction_label(candidates_count_tiebreak) == 1
    ...
    assert v0_53f_audit._select_fraction_label(candidates_min_lid) == 1

    # Highest fraction wins outright.
    candidates_simple = [(0, 0.3, 5), (1, 0.7, 1), (2, 0.5, 3)]
    assert v0_53f_audit._select_fraction_label(candidates_simple) == 1

    # NaN-loses: empty candidate list returns None.
    assert v0_53f_audit._select_fraction_label([]) is None
    ...
    all_lineages = [0, 1, 2]
    snaps_a = [
        v0_53f_audit._ReadinessSnapshot(agent_id=10, lineage_id=0, energy=10.0, age=2),
        v0_53f_audit._ReadinessSnapshot(agent_id=11, lineage_id=0, energy=4.0, age=2),
        v0_53f_audit._ReadinessSnapshot(agent_id=20, lineage_id=1, energy=10.0, age=2),
        v0_53f_audit._ReadinessSnapshot(agent_id=30, lineage_id=2, energy=10.0, age=2),
        v0_53f_audit._ReadinessSnapshot(agent_id=31, lineage_id=2, energy=10.0, age=2),
    ]
    selected_a, _, _, fr_a = v0_53f_audit._readiness_label_at_tick(
        all_lineages, snaps_a, energy_threshold, min_age
    )
    assert selected_a == 2
    assert fr_a[1] == 1.0
    assert fr_a[2] == 1.0
    selected_b, _, _, _ = v0_53f_audit._readiness_label_at_tick(
        all_lineages, snaps_a, energy_threshold, min_age
    )
    selected_c, _, _, _ = v0_53f_audit._readiness_label_at_tick(
        all_lineages, snaps_a, energy_threshold, min_age
    )
...
def test_pre200_window_strictly_extends_pre100_and_pre50_windows():
    capture = v0_53f_audit._RunCapture(
        arm=v0_53f_audit.ARM_C_WIDENED_METABOLIC_010,
    ...
    for tick_now in event_ticks:
        if tick_now > v0_53f_audit.TICK_200:
            continue
        if tick_now <= v0_53f_audit.TICK_50:
        ...
        if tick_now <= v0_53f_audit.TICK_100:
    ...
    capture2 = v0_53f_audit._RunCapture(
        arm=v0_53f_audit.ARM_C_WIDENED_METABOLIC_010,
        layout_name="widened_gradient",
        body_base_metabolic_cost=0.10,
        version="v0.42",
...
def test_subverdict_present_requires_two_thirds_firing_cells_with_nan_treated_as_non_firing_strict():  # noqa: E501
    ...
    summaries_a_2firing_1nan = _three_summaries_for_arm_tick200(
        arm, (+0.6, +0.6, float("nan")), v0_53f_audit.LABEL_A_NAME
    )
    summaries_b_clean = _three_summaries_for_arm_tick200(
        arm, (+0.6, +0.6, -0.6), v0_53f_audit.LABEL_B_TICK200_NAME
    )
    assert (
        v0_53f_audit._arm_subverdict_tick200(arm, summaries_a_2firing_1nan, summaries_b_clean)
        == v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT
    )
    ...
    summaries_a_1firing_2nan = _three_summaries_for_arm_tick200(
        arm, (+0.6, float("nan"), float("nan")), v0_53f_audit.LABEL_A_NAME
    )
    assert (
        v0_53f_audit._arm_subverdict_tick200(arm, summaries_a_1firing_2nan, summaries_b_clean)
        == v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PARTIAL
    )

    # Case: Label A 3 NaN cells (clears 0/3); Label B 3 firing -> PARTIAL.
    summaries_a_all_nan = _three_summaries_for_arm_tick200(
        arm, (float("nan"), float("nan"), float("nan")), v0_53f_audit.LABEL_A_NAME
    )
    assert (
        v0_53f_audit._arm_subverdict_tick200(arm, summaries_a_all_nan, summaries_b_clean)
        == v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PARTIAL
    )
    ...
    summaries_b_all_nan = _three_summaries_for_arm_tick200(
        ...
        v0_53f_audit.LABEL_B_TICK200_NAME,
    )
    assert (
        v0_53f_audit._arm_subverdict_tick200(arm, summaries_a_all_nan, summaries_b_all_nan)
        == v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_NOT_FOUND
    )

    # Case: Both labels 2 firing + 1 NaN -> both clear 2/3 -> PRESENT.
    summaries_b_2firing_1nan = _three_summaries_for_arm_tick200(
        arm, (+0.6, +0.6, float("nan")), v0_53f_audit.LABEL_B_TICK200_NAME
    )
    assert (
        v0_53f_audit._arm_subverdict_tick200(
...
def test_priority_3_relaxed_opposite_sign_halt_is_reachability_gated(tmp_path):
    ...
    arm_c = v0_53f_audit.ARM_C_WIDENED_METABOLIC_010
    ...
    summaries_a_wrong = _three_summaries_for_arm_tick200(
        arm_c, (+0.6, +0.6, -0.7), v0_53f_audit.LABEL_A_NAME
    )
    summaries_b_clean_above = _three_summaries_for_arm_tick200(
        arm_c, (+0.6, +0.6, +0.5), v0_53f_audit.LABEL_B_TICK200_NAME
    )
    c_sub_opposite = v0_53f_audit._arm_subverdict_tick200(
        arm_c, summaries_a_wrong, summaries_b_clean_above
    )
    assert c_sub_opposite == v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_OPPOSITE

    # ---- Branch A: C reach = 0.30 (>= 0.25) AND C OPPOSITE -> priority 3 fires.
    rollup_a, phrase_a = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        ...
        c_widened_metabolic_010_reachability_tick200=0.30,
    )
    assert rollup_a == v0_53f_audit.ROLLUP_RELAXED_OPPOSITE_SIGN_HALT
    assert (
    ...
    rollup_b, phrase_b = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=c_sub_opposite,
        ...
        bridge_re_anchor=bridge_clean,
        b_widened_v025_reachability_tick200=0.0,
        c_widened_metabolic_010_reachability_tick200=0.20,
    )
    assert rollup_b != v0_53f_audit.ROLLUP_RELAXED_OPPOSITE_SIGN_HALT
    assert rollup_b == (
        v0_53f_audit.ROLLUP_WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_BASE_METABOLIC_COST_010
    )
    assert (
        "The bridge is not rescued by `BodyConfig.base_metabolic_cost = 0.10` "
        "under V0_25 × `widened_gradient` × N_TICKS=200"  # noqa: RUF001
    ) in phrase_b

    # Wrong-sign cell collection: synthesize the full v0.53f summaries_tick200
    ...
    wrong_sign_cells = v0_53f_audit._collect_c_tick200_wrong_sign_cells(
    ...
    assert wsc.label == v0_53f_audit.LABEL_B_TICK200_NAME
    ...
    reachability_by_window: dict[int, dict[str, tuple[float, int]]] = {
        v0_53f_audit.TICK_50: {arm: (0.0, 64) for arm in v0_53f_audit.ARMS},
        v0_53f_audit.TICK_100: {arm: (0.0, 64) for arm in v0_53f_audit.ARMS},
        v0_53f_audit.TICK_200: {
            v0_53f_audit.ARM_A_NULL_V025: (1.0, 64),
            v0_53f_audit.ARM_B_WIDENED_V025: (0.0, 64),
            v0_53f_audit.ARM_C_WIDENED_METABOLIC_010: (0.20, 64),
        },
    }
    v0_53f_audit._write_audit_summary_csv(
        [],
        [],
        list(summaries_a_wrong) + list(summaries_b_clean_above),
        [],
        [],
        v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_sub_opposite,
    ...
    expected_prefix = (
        f"{arm_c}/{v0_53f_audit.LABEL_B_TICK200_NAME}/mean_distance_to_nearest_food_cell_tick200/"
    )
    ...
    summaries_a_clean_present = _three_summaries_for_arm_tick200(
        arm_c, (+0.6, +0.6, -0.6), v0_53f_audit.LABEL_A_NAME
    )
    summaries_b_clean_present = _three_summaries_for_arm_tick200(
        arm_c, (+0.6, +0.6, -0.6), v0_53f_audit.LABEL_B_TICK200_NAME
    )
    c_sub_present = v0_53f_audit._arm_subverdict_tick200(
        arm_c, summaries_a_clean_present, summaries_b_clean_present
    )
    assert c_sub_present == v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT

    rollup_c, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
    ...
    assert rollup_c == v0_53f_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_BASE_METABOLIC_COST_010
...
def test_b_widened_v025_categorical_anchor_at_tick_200():
    ...
    rollup_clean, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
    ...
    assert rollup_clean == v0_53f_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_BASE_METABOLIC_COST_010

    # B reach = 1/64 = 0.015625 -> priority 2 fires (categorical lock broken).
    one_sixty_fourth = 1.0 / 64.0
    rollup_drift, phrase_drift = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
    ...
    assert rollup_drift == v0_53f_audit.ROLLUP_ANCHOR_REPLICATION_HALT
    ...
    rollup_eps, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
    ...
    assert rollup_eps == v0_53f_audit.ROLLUP_ANCHOR_REPLICATION_HALT


# ---------------------------------------------------------------------------
# Test 15 — C_widened_metabolic_010 reachability threshold partition at tick-200.
...
def test_c_widened_metabolic_010_reachability_threshold_partition_at_tick_200():
    ...
    for c_kind in ("PRESENT", "PARTIAL", "NOT_FOUND"):
        c_sub = _arm_subverdict_for_tick200(v0_53f_audit.ARM_C_WIDENED_METABOLIC_010, c_kind)
        rollup, phrase = v0_53f_audit._evaluate_rollup(
            a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
            a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
            b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
    ...
    rollup_present, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
    ...
    assert rollup_present == v0_53f_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_BASE_METABOLIC_COST_010
    ...
    for c_kind in ("PARTIAL", "NOT_FOUND"):
        ...
        assert rollup == (
            v0_53f_audit.ROLLUP_WIDENED_BRIDGE_PARTIALLY_RESCUED_BY_BASE_METABOLIC_COST_010
        )
...
def test_rollup_locked_phrases_fire_verbatim_and_priority_cascade_partition_total():
    ...
    bridge_drift[0] = v0_53f_audit.BridgeReAnchorRow(
    ...
    _, phrase_p3 = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
        b_widened_v025_reachability_tick200=0.0,
        c_widened_metabolic_010_reachability_tick200=0.50,
    ...
    # Priority 4 RESCUED.
    _, phrase_rescued = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
    ...
    assert (
        ...
        "founder per-tick metabolic depletion rate, not by the geometry alone"
    ) in phrase_rescued
    ...
    _, phrase_below = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_PRESENT,
        ...
        bridge_re_anchor=bridge_clean,
        b_widened_v025_reachability_tick200=0.0,
        c_widened_metabolic_010_reachability_tick200=0.10,
    )
    assert (
        "The bridge is not rescued by `BodyConfig.base_metabolic_cost = 0.10` "
        "under V0_25 × `widened_gradient` × N_TICKS=200"  # noqa: RUF001
    ...
    _, phrase_partial = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_NOT_FOUND,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
        b_widened_v025_reachability_tick200=0.0,
        c_widened_metabolic_010_reachability_tick200=0.30,
    ...
    rollup_1, phrase_1 = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_NOT_FOUND,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_OPPOSITE,
    ...
    assert rollup_1 == v0_53f_audit.ROLLUP_CORPUS_DRIFT_HALT
    assert "v0.42" in phrase_1

    # Priority 2.a only (Tier-1 drift): wins over downstream halts.
    rollup_2a, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_OPPOSITE,
    ...
    assert rollup_2a == v0_53f_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    # Priority 2.b only (A_null tick-50 sub-verdict != PRESENT).
    rollup_2b, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_NOT_FOUND,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_OPPOSITE,
    ...
    assert rollup_2b == v0_53f_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    # Priority 2.c only (B_widened categorical anchor broken).
    rollup_2c, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_OPPOSITE,
    ...
    assert rollup_2c == v0_53f_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    # Priority 3 alone (C OPPOSITE; reach >= 0.25; all priority-2 conditions clean).
    rollup_3, _ = v0_53f_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
        b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
        c_tick200_subverdict=v0_53f_audit.SUBVERDICT_C_METABOLIC_010_TICK200_OPPOSITE,
    ...
    assert rollup_3 == v0_53f_audit.ROLLUP_RELAXED_OPPOSITE_SIGN_HALT
    ...
    for c_kind in sub_kinds_all:
        ...
        rollup_above, _ = v0_53f_audit._evaluate_rollup(
            a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
            a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
            b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
            c_tick200_subverdict=c_sub,
        ...
        rollup_below, _ = v0_53f_audit._evaluate_rollup(
            a_null_tick50_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
            a_null_tick200_subverdict=v0_53f_audit.SUBVERDICT_A_NULL_V025_TICK200_PRESENT,
            b_tick200_subverdict=v0_53f_audit.SUBVERDICT_B_WIDENED_V025_TICK200_NOT_FOUND,
            c_tick200_subverdict=c_sub,
    ...
    rescued = v0_53f_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_BASE_METABOLIC_COST_010
    partial_outcome = (
        v0_53f_audit.ROLLUP_WIDENED_BRIDGE_PARTIALLY_RESCUED_BY_BASE_METABOLIC_COST_010
    )
    below = v0_53f_audit.ROLLUP_WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_BASE_METABOLIC_COST_010
    relaxed_opp = v0_53f_audit.ROLLUP_RELAXED_OPPOSITE_SIGN_HALT
