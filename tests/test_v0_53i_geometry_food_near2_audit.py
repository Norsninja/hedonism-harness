"""v0.53i geometry food-near2 audit (n_ticks=400 on C arm) — tests.

16 locked tests. Pre-reg: [[docs/experiments/fear_hunger_v0.53i.md]] §"Test
list (locked, 16 tests)". Tests numbered to match the pre-reg's ordering.
Test #5 verifies the script-local layout, BOTH BodyConfig knobs, AND
asymmetric-horizon propagation (B tick_count==200, C tick_count==400 after
run_chamber returns), with explicit cross-arm geometry asserts. Test #14
asserts no Tier-3 leg exists in v0.53i (rollup function does NOT accept a
``c_reachability_tick200`` parameter — regression guard).
"""
...
v0_53i_audit = importlib.util.module_from_spec(_spec)
sys.modules["v0_53i_audit"] = v0_53i_audit
_spec.loader.exec_module(v0_53i_audit)
...
def _make_summary(
    *,
    ...
    fires_expected = (not math.isnan(signed)) and signed >= v0_53i_audit.COHENS_D_THRESHOLD
    fires_wrong = (not math.isnan(signed)) and signed <= -v0_53i_audit.COHENS_D_THRESHOLD
    return v0_53i_audit.ObservableSummary(
        arm=arm,
...
def _three_summaries_for_arm_window(
    ...
    obs_table = {
        v0_53i_audit.TICK_50: v0_53i_audit.PRIMARY_OBSERVABLES_TICK50,
        v0_53i_audit.TICK_100: v0_53i_audit.PRIMARY_OBSERVABLES_TICK100,
        v0_53i_audit.TICK_200: v0_53i_audit.PRIMARY_OBSERVABLES_TICK200,
        v0_53i_audit.TICK_400: v0_53i_audit.PRIMARY_OBSERVABLES_TICK400,
    }
...
def _zero_drift_bridge_re_anchor() -> list[object]:
    return [
        v0_53i_audit.BridgeReAnchorRow(
            label=label,
            observable=obs,
        ...
        for (label, obs), ref in v0_53i_audit.V048_PUBLISHED_SIGNED_D.items()
    ]


def _c_tick400_subverdict_for_kind(kind: str) -> str:
    table = {
        "PRESENT": v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
        "PARTIAL": v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PARTIAL,
        "NOT_FOUND": v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_NOT_FOUND,
        "OPPOSITE": v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_OPPOSITE,
    }
    return table[kind]
...
# AND Tier-1 reference constants byte-equal v0.48..v0.53h published.
# ---------------------------------------------------------------------------
...
def test_paired_d_function_reproduces_hand_computed_signed_d_on_fixture_and_tier1_constants_match_v048_published_values():  # noqa: E501
    ...
    derived_d = v0_53i_audit._paired_cohens_d(deltas)
    ...
    assert pinned_v048 == v0_53i_audit.V048_PUBLISHED_SIGNED_D
...
def test_a_null_v025_corpus_a_share_h8_re_anchors_v042_v044_v045():
    clean = [
        v0_53i_audit.ReAnchorRow(
            arm=v0_53i_audit.ARM_A_NULL_V025,
            version=ver,
            hazard=8,
    ...
    rollup, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
    ...
    assert rollup == v0_53i_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_FOOD_NEAR2

    # Drift > 1e-3 on v0.44 -> CORPUS_REDERIVE_DRIFT_HALT.
    drifted = list(clean)
    drifted[1] = v0_53i_audit.ReAnchorRow(
        arm=v0_53i_audit.ARM_A_NULL_V025,
        version="v0.44",
        hazard=8,
        n_runs_contributing=8,
    ...
    rollup_d, phrase_d = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
    ...
    assert rollup_d == v0_53i_audit.ROLLUP_CORPUS_DRIFT_HALT
...
def test_arm_a_null_v025_uses_tight_gradient_layout_default_body_config_and_n_ticks_200_with_explicit_geometry_asserts():  # noqa: E501
    layout = v0_53i_audit._layout_for_arm(v0_53i_audit.ARM_A_NULL_V025)
    ...
    assert v0_53i_audit.LAYOUT_NAME_BY_ARM[v0_53i_audit.ARM_A_NULL_V025] == "tight_gradient"
    assert v0_53i_audit._body_config_for_arm(v0_53i_audit.ARM_A_NULL_V025) is None
    assert (
        v0_53i_audit.BODY_BASE_METABOLIC_COST_BY_ARM[v0_53i_audit.ARM_A_NULL_V025]
        == v0_53i_audit.V0_25_BODY_BASE_METABOLIC_COST
        == 0.25
    )
    # Horizon invariant: A runs to n_ticks=200.
    assert v0_53i_audit.N_TICKS_BY_ARM[v0_53i_audit.ARM_A_NULL_V025] == 200
    assert (
        v0_53i_audit.WINDOWS_BY_ARM[v0_53i_audit.ARM_A_NULL_V025]
        == v0_53i_audit.WINDOWS_AB
        == (50, 100, 200)
    )
...
def test_arm_b_widened_v025_uses_widened_gradient_layout_default_body_config_and_n_ticks_200_with_explicit_geometry_asserts():  # noqa: E501
    layout = v0_53i_audit._layout_for_arm(v0_53i_audit.ARM_B_WIDENED_V025)
    assert layout.safe_x_min == 0
    ...
    assert v0_53i_audit.LAYOUT_NAME_BY_ARM[v0_53i_audit.ARM_B_WIDENED_V025] == "widened_gradient"
    assert v0_53i_audit._body_config_for_arm(v0_53i_audit.ARM_B_WIDENED_V025) is None
    assert (
        v0_53i_audit.BODY_BASE_METABOLIC_COST_BY_ARM[v0_53i_audit.ARM_B_WIDENED_V025]
        == v0_53i_audit.V0_25_BODY_BASE_METABOLIC_COST
        == 0.25
    )
    # Horizon invariant: B runs to n_ticks=200.
    assert v0_53i_audit.N_TICKS_BY_ARM[v0_53i_audit.ARM_B_WIDENED_V025] == 200
    assert (
        v0_53i_audit.WINDOWS_BY_ARM[v0_53i_audit.ARM_B_WIDENED_V025]
        == v0_53i_audit.WINDOWS_AB
        == (50, 100, 200)
    )
...
# ---------------------------------------------------------------------------
# Test 5 — Cross-arm contrast verifying the script-local C layout, BOTH
# BodyConfig knobs, AND the asymmetric n_ticks horizon. The food_x_min shift
# (10 -> 8) is the positive intervention; preserved invariants
# (food_width=5, hazard_x, safe_x, spawn_x=1, height=6) and secondary
# invariants (food_x_max=14 vs 12, world_width=15 vs 13) are also asserted.
# ---------------------------------------------------------------------------


def test_arm_c_widened_food_near2_combined_N400_seam_differentiates_b_and_c_layout_food_x_min_shift_body_config_two_knobs_and_horizon_at_tick_400(  # noqa: E501, N802, PLR0915
    tmp_path,
):
    arm_c = v0_53i_audit.ARM_C_WIDENED_FOOD_NEAR2_COMBINED_N400
    bc_c = v0_53i_audit._body_config_for_arm(arm_c)
    ...
    assert v0_53i_audit.STARTING_ENERGY_100_DOSE == 100.0
    assert v0_53i_audit.BASE_METABOLIC_COST_010_DOSE == 0.10

    # No other WorldConfig knob differs from V0_25 baseline on C.
    base_arm = v0_53i_audit._select_a_null_arm("v0.42", 0)
    assert base_arm.ambient_influx_rate == v0_53i_audit.V0_25_AMBIENT_INFLUX_RATE == 1.0
    assert base_arm.energy_pool_initial == v0_53i_audit.V0_25_ENERGY_POOL_INITIAL == 1500.0
    assert base_arm.food_respawn_cooldown == v0_53i_audit.V0_25_FOOD_RESPAWN_COOLDOWN == 50

    # Asymmetric n_ticks: A=B=200, C=400.
    assert v0_53i_audit.N_TICKS_BY_ARM[v0_53i_audit.ARM_B_WIDENED_V025] == 200
    assert v0_53i_audit.N_TICKS_BY_ARM[arm_c] == 400

    # Module-level layout constant is exposed and constructed script-local.
    assert isinstance(v0_53i_audit.WIDENED_FOOD_NEAR2_LAYOUT, ChamberLayout)
    wf = v0_53i_audit.WIDENED_FOOD_NEAR2_LAYOUT
    assert wf.safe_x_min == 0
    assert wf.safe_x_max == 4
    assert wf.hazard_x_min == 5
    assert wf.hazard_x_max == 7
    assert wf.food_x_min == 8
    assert wf.food_x_max == 12
    assert wf.height == 6
    assert wf.resolved_spawn_x == 1
    assert wf.width == 13

    # Runtime: same (version, seed, hazard); B must end at tick_count=200,
    # C must end at tick_count=400; founder body fields differ at tick-0;
    # layouts differ.
    seed = 41
    cap_b = v0_53i_audit._run_one_arm(
        arm=v0_53i_audit.ARM_B_WIDENED_V025,
        version="v0.42",
        seed=seed,
        hazard=0,
        runs_root=tmp_path,
    )
    cap_c = v0_53i_audit._run_one_arm(
        arm=arm_c,
        version="v0.42",
        seed=seed,
        hazard=0,
    ...
    # Layout names diverge: B uses widened_gradient, C uses widened_food_near2.
    assert cap_b.layout_name == "widened_gradient"
    assert cap_c.layout_name == "widened_food_near2"

    # Asymmetric horizon: cap_b.final_tick_count == 200 and cap_c.final_tick_count
    # == 400 (read from per-tick observer's last fire). Allow earlier termination
    ...
    # Strict-extension invariant: when B reaches tick-200, C must reach
    # strictly past tick-200.
    ...
    # Founder body fields at tick-0.
    # A founder body fields (default) — re-derive locally to verify A's contract.
    cap_a = v0_53i_audit._run_one_arm(
        arm=v0_53i_audit.ARM_A_NULL_V025,
        version="v0.42",
        seed=seed,
        hazard=0,
    ...
    for rec in cap_a.founder_records:
    ...
    # A layout geometry assert (matches test #3).
    assert cap_a.safe_x_min == 0
    assert cap_a.safe_x_max == 2
    assert cap_a.hazard_x_min == 3
    assert cap_a.hazard_x_max == 4
    assert cap_a.food_x_min == 5
    assert cap_a.food_x_max == 8
    assert cap_a.spawn_x == 1
    assert cap_a.height == 6
    assert cap_a.world_width == 9
    ...
    for rec in cap_b.founder_records:
        ...
        assert rec.founder_body_starting_energy_tick0 == 60.0
        assert rec.founder_body_base_metabolic_cost_tick0 == 0.25
    # B layout geometry asserts.
    assert cap_b.food_x_min == 10
    assert cap_b.food_x_max == 14
    assert cap_b.hazard_x_min == 5
    assert cap_b.hazard_x_max == 7
    assert cap_b.safe_x_min == 0
    assert cap_b.safe_x_max == 4
    assert cap_b.spawn_x == 1
    assert cap_b.height == 6
    ...
    assert v0_53i_audit.BODY_STARTING_ENERGY_BY_ARM[arm_c] == 100.0
    assert v0_53i_audit.BODY_BASE_METABOLIC_COST_BY_ARM[arm_c] == 0.10

    # C layout geometry asserts (script-local widened_food_near2).
    assert cap_c.food_x_min == 8, "C food_x_min must be 8 (NOT 10 — corridor removed)"
    assert cap_c.food_x_max == 12, "C food_x_max must be 12 (NOT 14)"
    ...
    assert cap_c.world_width == 13, "C world_width must be 13 (NOT 15)"

    # B vs C layout cross-arm contrast — POSITIVE INTERVENTION
    # (specifically asserts the food band shift).
    assert cap_b.food_x_min == 10
    assert cap_c.food_x_min == 8

    # B vs C layout cross-arm contrast — PRESERVED INVARIANTS.
    # Food width preserved at 5 columns on both arms.
    assert (cap_b.food_x_max - cap_b.food_x_min + 1) == 5
    assert (cap_c.food_x_max - cap_c.food_x_min + 1) == 5
    assert (
        (cap_b.food_x_max - cap_b.food_x_min + 1) == (cap_c.food_x_max - cap_c.food_x_min + 1) == 5
    )
    # Hazard band preserved.
    assert cap_b.hazard_x_min == cap_c.hazard_x_min == 5
    assert cap_b.hazard_x_max == cap_c.hazard_x_max == 7
    # Safe band preserved.
    assert cap_b.safe_x_min == cap_c.safe_x_min == 0
    assert cap_b.safe_x_max == cap_c.safe_x_max == 4
    # Spawn preserved.
    assert cap_b.spawn_x == cap_c.spawn_x == 1
    # Height preserved.
    assert cap_b.height == cap_c.height == 6

    # B vs C layout cross-arm contrast — SECONDARY (consequences of the
    # food-band shift).
    assert cap_b.food_x_max == 14
    assert cap_c.food_x_max == 12
    assert cap_b.world_width == 15
    assert cap_c.world_width == 13
...
def test_founder_traits_byte_identical_across_arms_for_same_seed(tmp_path):
    ...
    for arm in v0_53i_audit.ARMS:
        cap = v0_53i_audit._run_one_arm(
...
# All three layouts have spawn_x=1 and height=6, so positions are byte-identical.
# ---------------------------------------------------------------------------
...
def test_founder_positions_byte_identical_across_arms_for_same_seed():
    ...
    expected_ys = None
    for arm in v0_53i_audit.ARMS:
        layout = v0_53i_audit._layout_for_arm(arm)
        spawn_x = layout.resolved_spawn_x
        ys = spread_y(v0_53i_audit.N_FOUNDERS, layout.height)
...
# ---------------------------------------------------------------------------
# Test 8 — Two-part src/ pinning test (IDENTICAL SHAs to v0.53e/f/g/h):
...
def test_no_src_modifications_compared_to_v0_53e_tip():
    ...
    for rel_path, expected_hash in V052B_TIP_SHA256.items():
        ...
        if actual_hash != expected_hash:
            raise AssertionError(
                "v0.53i is pre-registered to leave the science-core five files "
    ...
    if actual_chamber_hash != V053E_CHAMBER_DRIVER_SHA256:
        raise AssertionError(
            "v0.53i is pre-registered to leave the chamber driver byte-identical "
...
def test_label_a_high_sensor_radius_lineage_picks_correct_lineage():
    ...
    label = v0_53i_audit._select_sensor_radius_label(sensor_radius_by_lineage)
    assert label == 4

    sensor_tied = {0: 6, 1: 5, 2: 6, 3: 6, 4: 4}
    label_tied = v0_53i_audit._select_sensor_radius_label(sensor_tied)
    assert label_tied == 0
...
def _build_capture_minimal(arm: str, n_ticks: int) -> object:
    layout = v0_53i_audit._layout_for_arm(arm)
    cap = v0_53i_audit._RunCapture(
        arm=arm,
        layout_name=v0_53i_audit.LAYOUT_NAME_BY_ARM[arm],
        ...
        body_starting_energy=v0_53i_audit.BODY_STARTING_ENERGY_BY_ARM[arm],
        body_base_metabolic_cost=v0_53i_audit.BODY_BASE_METABOLIC_COST_BY_ARM[arm],
        n_ticks=n_ticks,
        version="v0.42",
        seed=41,
        hazard=0,
...
def test_label_b_four_variants_three_tier_tiebreak_at_each_window_with_pre400_c_only():
    ...
    assert v0_53i_audit._select_fraction_label(candidates_count_tiebreak) == 1

    # Tie on fraction AND count -> tiebreak by min(lineage_id).
    candidates_min_lid = [(3, 0.5, 4), (1, 0.5, 4), (2, 0.5, 4)]
    assert v0_53i_audit._select_fraction_label(candidates_min_lid) == 1

    candidates_simple = [(0, 0.3, 5), (1, 0.7, 1), (2, 0.5, 3)]
    assert v0_53i_audit._select_fraction_label(candidates_simple) == 1

    assert v0_53i_audit._select_fraction_label([]) is None

    energy_threshold = 5.0
    min_age = 1
    all_lineages = [0, 1, 2]
    snaps = [
        v0_53i_audit._ReadinessSnapshot(agent_id=10, lineage_id=0, energy=10.0, age=2),
        v0_53i_audit._ReadinessSnapshot(agent_id=11, lineage_id=0, energy=4.0, age=2),
        v0_53i_audit._ReadinessSnapshot(agent_id=20, lineage_id=1, energy=10.0, age=2),
        v0_53i_audit._ReadinessSnapshot(agent_id=30, lineage_id=2, energy=10.0, age=2),
        v0_53i_audit._ReadinessSnapshot(agent_id=31, lineage_id=2, energy=10.0, age=2),
    ]
    selected_a, _, _, fr_a = v0_53i_audit._readiness_label_at_tick(
        all_lineages, snaps, energy_threshold, min_age
    )
    assert selected_a == 2
    assert fr_a[1] == 1.0
    assert fr_a[2] == 1.0
    selected_b, _, _, _ = v0_53i_audit._readiness_label_at_tick(
        all_lineages, snaps, energy_threshold, min_age
    )
    selected_c, _, _, _ = v0_53i_audit._readiness_label_at_tick(
        all_lineages, snaps, energy_threshold, min_age
    )
    assert selected_a == selected_b == selected_c

    # tick-400 label is computed on C arm only; on A/B the column carries NaN.
    cap_a = _build_capture_minimal(v0_53i_audit.ARM_A_NULL_V025, 200)
    cap_b = _build_capture_minimal(v0_53i_audit.ARM_B_WIDENED_V025, 200)
    cap_c = _build_capture_minimal(v0_53i_audit.ARM_C_WIDENED_FOOD_NEAR2_COMBINED_N400, 400)
    rows_a = v0_53i_audit._aggregate_per_lineage(cap_a)
    rows_b = v0_53i_audit._aggregate_per_lineage(cap_b)
    rows_c = v0_53i_audit._aggregate_per_lineage(cap_c)
    assert len(rows_a) == 1
    assert len(rows_b) == 1
    assert len(rows_c) == 1
...
def test_pre400_window_strictly_extends_pre200_pre100_pre50_windows_on_c_arm():
    arm_c = v0_53i_audit.ARM_C_WIDENED_FOOD_NEAR2_COMBINED_N400
    layout_c = v0_53i_audit._layout_for_arm(arm_c)
    capture = v0_53i_audit._RunCapture(
        arm=arm_c,
        layout_name="widened_food_near2",
        safe_x_min=int(layout_c.safe_x_min),
        safe_x_max=int(layout_c.safe_x_max),
        hazard_x_min=int(layout_c.hazard_x_min),
        hazard_x_max=int(layout_c.hazard_x_max),
        food_x_min=int(layout_c.food_x_min),
        food_x_max=int(layout_c.food_x_max),
        world_width=int(layout_c.width),
        spawn_x=int(layout_c.resolved_spawn_x),
        height=int(layout_c.height),
    ...
    for tick_now in event_ticks:
        if tick_now > arm_horizon:
            continue
        if tick_now <= v0_53i_audit.TICK_50:
        ...
        if tick_now <= v0_53i_audit.TICK_100:
        ...
        if tick_now <= v0_53i_audit.TICK_200:
        ...
        if tick_now <= v0_53i_audit.TICK_400:
...
def test_subverdict_present_requires_two_thirds_firing_cells_with_nan_treated_as_non_firing_strict():  # noqa: E501
    arm = v0_53i_audit.ARM_C_WIDENED_FOOD_NEAR2_COMBINED_N400
    window = v0_53i_audit.TICK_400

    # Case: Label A 2 firing + 1 NaN; Label B 3 firing -> PRESENT.
    summaries_a_2firing_1nan = _three_summaries_for_arm_window(
        arm, window, (+0.6, +0.6, float("nan")), v0_53i_audit.LABEL_A_NAME
    )
    summaries_b_clean = _three_summaries_for_arm_window(
        arm, window, (+0.6, +0.6, -0.6), v0_53i_audit.LABEL_B_TICK400_NAME
    )
    assert (
        v0_53i_audit._arm_subverdict_at_window(
            arm, window, summaries_a_2firing_1nan, summaries_b_clean
        )
        == v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT
    )
    ...
    summaries_a_1firing_2nan = _three_summaries_for_arm_window(
        arm, window, (+0.6, float("nan"), float("nan")), v0_53i_audit.LABEL_A_NAME
    )
    assert (
        v0_53i_audit._arm_subverdict_at_window(
            arm, window, summaries_a_1firing_2nan, summaries_b_clean
        )
        == v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PARTIAL
    )

    # Case: Label A all NaN; Label B 3 firing -> PARTIAL.
    summaries_a_all_nan = _three_summaries_for_arm_window(
        arm, window, (float("nan"), float("nan"), float("nan")), v0_53i_audit.LABEL_A_NAME
    )
    assert (
        v0_53i_audit._arm_subverdict_at_window(arm, window, summaries_a_all_nan, summaries_b_clean)
        == v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PARTIAL
    )
...
def test_priority_3_geometry_opposite_sign_halt_is_reachability_gated_on_c_tick_400(tmp_path):
    ...
    summaries_a_wrong = _three_summaries_for_arm_window(
        arm_c, window, (+0.6, +0.6, -0.7), v0_53i_audit.LABEL_A_NAME
    )
    summaries_b_clean_above = _three_summaries_for_arm_window(
        arm_c, window, (+0.6, +0.6, +0.5), v0_53i_audit.LABEL_B_TICK400_NAME
    )
    c_sub_opposite = v0_53i_audit._arm_subverdict_at_window(
        arm_c, window, summaries_a_wrong, summaries_b_clean_above
    )
    assert c_sub_opposite == v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_OPPOSITE

    # Branch A: C reach = 0.30 + C OPPOSITE -> priority 3 fires.
    rollup_a, phrase_a = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
    ...
    assert rollup_a == v0_53i_audit.ROLLUP_GEOMETRY_OPPOSITE_SIGN_HALT
    assert (
    ...
    rollup_b, phrase_b = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=c_sub_opposite,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_b != v0_53i_audit.ROLLUP_GEOMETRY_OPPOSITE_SIGN_HALT
    assert rollup_b == (v0_53i_audit.ROLLUP_WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_FOOD_NEAR2)
    assert (
        "The bridge is not rescued by reducing post-hazard food distance by two "
        "columns under V0_25 × `widened_gradient`-shape × combined-budget "  # noqa: RUF001
        "envelope × `n_ticks=400`"  # noqa: RUF001
    ) in phrase_b

    # Wrong-sign cell collection on the synthetic tick-400 summaries.
    wrong_sign_cells = v0_53i_audit._collect_c_tick400_wrong_sign_cells(
    ...
    assert wsc.label == v0_53i_audit.LABEL_B_TICK400_NAME
    ...
    arms_for_window = {
        v0_53i_audit.TICK_50: v0_53i_audit.ARMS,
        v0_53i_audit.TICK_100: v0_53i_audit.ARMS,
        v0_53i_audit.TICK_200: v0_53i_audit.ARMS,
        v0_53i_audit.TICK_400: (v0_53i_audit.ARM_C_WIDENED_FOOD_NEAR2_COMBINED_N400,),
    }
    ...
    reachability_by_window[v0_53i_audit.TICK_200][v0_53i_audit.ARM_A_NULL_V025] = (1.0, 64)
    reachability_by_window[v0_53i_audit.TICK_200][v0_53i_audit.ARM_B_WIDENED_V025] = (0.0, 64)
    reachability_by_window[v0_53i_audit.TICK_200][arm_c] = (0.0, 64)
    reachability_by_window[v0_53i_audit.TICK_400][arm_c] = (0.20, 64)

    summaries_by_window = {
        v0_53i_audit.TICK_50: [],
        v0_53i_audit.TICK_100: [],
        v0_53i_audit.TICK_200: [],
        v0_53i_audit.TICK_400: list(summaries_a_wrong) + list(summaries_b_clean_above),
    }
    v0_53i_audit._write_audit_summary_csv(
        summaries_by_window,
        [],
        [],
        v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
    ...
    expected_prefix = (
        f"{arm_c}/{v0_53i_audit.LABEL_B_TICK400_NAME}/mean_distance_to_nearest_food_cell_tick400/"
    )
    ...
    summaries_a_clean_present = _three_summaries_for_arm_window(
        arm_c, window, (+0.6, +0.6, -0.6), v0_53i_audit.LABEL_A_NAME
    )
    summaries_b_clean_present = _three_summaries_for_arm_window(
        arm_c, window, (+0.6, +0.6, -0.6), v0_53i_audit.LABEL_B_TICK400_NAME
    )
    c_sub_present = v0_53i_audit._arm_subverdict_at_window(
        arm_c, window, summaries_a_clean_present, summaries_b_clean_present
    )
    assert c_sub_present == v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT
    rollup_c, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
    ...
    assert rollup_c == v0_53i_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_FOOD_NEAR2


# ---------------------------------------------------------------------------
# Test 14 — Tier-2 categorical anchor on B_widened_V0_25 at tick-200 AND
# regression guard: NO Tier-3 leg in v0.53i (rollup function does NOT accept
# a ``c_reachability_tick200`` parameter).
#   Synthetic B reach=0.0 -> priority 2 does NOT fire.
#   Synthetic B reach=1/64 -> ANCHOR_REPLICATION_HALT (Tier-2).
#   inspect.signature(compute_slice_rollup_verdict) lacks 'c_reachability_tick200'.
# ---------------------------------------------------------------------------


def test_b_widened_v025_categorical_anchor_at_tick_200_no_tier3_in_v053i():
    bridge_clean = _zero_drift_bridge_re_anchor()

    # Clean -> rollup goes to priority 4.
    rollup_clean, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_clean == v0_53i_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_FOOD_NEAR2

    one_sixty_fourth = 1.0 / 64.0

    # Tier-2 broken (B reach = 1/64) -> ANCHOR_REPLICATION_HALT.
    rollup_b_drift, phrase_b_drift = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_b_drift == v0_53i_audit.ROLLUP_ANCHOR_REPLICATION_HALT
    assert "B_widened_V0_25" in phrase_b_drift or "0/64" in phrase_b_drift

    # Integer-categorical: even 1e-9 trips the halt.
    rollup_b_eps, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_b_eps == v0_53i_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    # Regression guard — NO Tier-3 leg in v0.53i. The public rollup function
    # MUST NOT accept a ``c_reachability_tick200`` parameter (if a future patch
    # adds one — e.g. accidentally re-introducing v0.53h's Tier-3 anchor —
    # this test halts).
    sig = inspect.signature(v0_53i_audit.compute_slice_rollup_verdict)
    assert "c_reachability_tick200" not in sig.parameters, (
        f"v0.53i compute_slice_rollup_verdict must NOT accept "
        f"`c_reachability_tick200` (Tier-3 was removed in v0.53i); got "
        f"parameters: {list(sig.parameters)}"
    )
    sig_eval = inspect.signature(v0_53i_audit._evaluate_rollup)
    assert "c_reachability_tick200" not in sig_eval.parameters, (
        f"v0.53i _evaluate_rollup must NOT accept `c_reachability_tick200`; "
        f"got parameters: {list(sig_eval.parameters)}"
    )
...
def test_c_tick_400_reachability_threshold_partition():
    ...
    for c_kind in ("PRESENT", "PARTIAL", "NOT_FOUND"):
        ...
        rollup, phrase = v0_53i_audit._evaluate_rollup(
            a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        ...
        assert rollup == (v0_53i_audit.ROLLUP_WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_FOOD_NEAR2)
        assert (
            "The bridge is not rescued by reducing post-hazard food distance by two "
            "columns under V0_25 × `widened_gradient`-shape × combined-budget "  # noqa: RUF001
            "envelope × `n_ticks=400`"  # noqa: RUF001
    ...
    rollup_present, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_present == v0_53i_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_FOOD_NEAR2
    ...
    for c_kind in ("PARTIAL", "NOT_FOUND"):
        ...
        assert rollup == (v0_53i_audit.ROLLUP_WIDENED_BRIDGE_PARTIALLY_RESCUED_BY_FOOD_NEAR2)
...
# Predecessor references to v0.53c/d/e/f/g/h must appear in priority 4/5/6 phrases.
# ---------------------------------------------------------------------------
...
def test_rollup_locked_phrases_fire_verbatim_and_priority_cascade_partition_total():  # noqa: PLR0915
    ...
    bridge_drift[0] = v0_53i_audit.BridgeReAnchorRow(
    ...
    _, phrase_p3 = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
        b_widened_v025_reachability_tick200=0.0,
        c_reachability_tick400=0.50,
    ...
    # Priority 4 RESCUED.
    _, phrase_rescued = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert (
        "Reducing post-hazard food distance by two columns is sufficient to "
        "restore measurable reachability and bridge expression under the "
        "combined-budget envelope at `n_ticks=400` on the V0_25 substrate"
    ) in phrase_rescued
    assert (
        "The v0.53c–v0.53h reachability ceiling is lifted by reducing "  # noqa: RUF001
        "post-hazard food distance under the tested envelope"
    ) in phrase_rescued
    assert (
        "this does NOT prove `geometry solved` — only that this specific "
        "2-column reduction is sufficient under the tested envelope"
    ) in phrase_rescued
    ...
    assert "WIDENED_BELOW_REACHABILITY_THRESHOLD_AT_TIME_HORIZON_400" in phrase_rescued

    # Priority 5 BELOW_THRESHOLD.
    _, phrase_below = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert (
        "the tested 2-column reduction does NOT prove `geometry irrelevant` "
        "or `corridor removal proves distance was not the problem`"
    ) in phrase_below
    assert (
    ...
    assert "WIDENED_BELOW_REACHABILITY_THRESHOLD_AT_TIME_HORIZON_400" in phrase_below

    # Priority 6 PARTIALLY_RESCUED.
    _, phrase_partial = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_NOT_FOUND,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
        b_widened_v025_reachability_tick200=0.0,
        c_reachability_tick400=0.30,
    ...
    assert "WIDENED_BELOW_REACHABILITY_THRESHOLD_AT_TIME_HORIZON_400" in phrase_partial

    # Priority cascade: 1 > 2.a > 2.b > 2.c > 3 > 4/5/6.
    rollup_1, phrase_1 = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_NOT_FOUND,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_OPPOSITE,
    ...
    assert rollup_1 == v0_53i_audit.ROLLUP_CORPUS_DRIFT_HALT
    assert "v0.42" in phrase_1

    rollup_2a, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_drift,
    ...
    assert rollup_2a == v0_53i_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    rollup_2b, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_NOT_FOUND,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_2b == v0_53i_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    rollup_2c, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_2c == v0_53i_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    rollup_3, _ = v0_53i_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53i_audit.SUBVERDICT_C_FOOD_NEAR2_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_3 == v0_53i_audit.ROLLUP_GEOMETRY_OPPOSITE_SIGN_HALT
    ...
    for c_kind in sub_kinds_all:
        ...
        rollup_above, _ = v0_53i_audit._evaluate_rollup(
            a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
            c_tick400_subverdict=c_sub,
            corpus_re_anchor=[],
            bridge_re_anchor=bridge_clean,
        ...
        rollup_below, _ = v0_53i_audit._evaluate_rollup(
            a_null_tick50_subverdict=v0_53i_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
            c_tick400_subverdict=c_sub,
            corpus_re_anchor=[],
            bridge_re_anchor=bridge_clean,
    ...
    rescued = v0_53i_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_FOOD_NEAR2
    partial_outcome = v0_53i_audit.ROLLUP_WIDENED_BRIDGE_PARTIALLY_RESCUED_BY_FOOD_NEAR2
    below = v0_53i_audit.ROLLUP_WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_FOOD_NEAR2
    geometry_opp = v0_53i_audit.ROLLUP_GEOMETRY_OPPOSITE_SIGN_HALT
