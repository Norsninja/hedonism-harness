"""v0.53k perception sensor_radius_8 audit (4-arm; n_ticks=400 on C/D) — tests.

16 locked tests. Pre-reg: [[docs/experiments/fear_hunger_v0.53k.md]] §"Test
list (locked, 16 tests)". Tests numbered to match the pre-reg's ordering.
Test #5 / #6 split the v0.53j combined C+D body_config / layout test into two
arm-specific tests, each with explicit perception-axis asserts. Test #7 is
new: cross-arm perception contrast (C has override=8, D has no override),
which absorbs v0.53j's `food_x_min` shift contrast. Test #14 exercises the
Tier-3 D positive anchor cascade (three independent halt branches:
reachability, sub-verdict, paired_d drift).
"""
...
_SCRIPT_PATH = (
    Path(__file__).parent.parent / "scripts" / "v0_53k_perception_sensor_radius_8_audit.py"
)
_spec = importlib.util.spec_from_file_location("v0_53k_audit", _SCRIPT_PATH)
assert _spec is not None
assert _spec.loader is not None
v0_53k_audit = importlib.util.module_from_spec(_spec)
sys.modules["v0_53k_audit"] = v0_53k_audit
_spec.loader.exec_module(v0_53k_audit)
...
def _make_summary(
    *,
    ...
    fires_expected = (not math.isnan(signed)) and signed >= v0_53k_audit.COHENS_D_THRESHOLD
    fires_wrong = (not math.isnan(signed)) and signed <= -v0_53k_audit.COHENS_D_THRESHOLD
    return v0_53k_audit.ObservableSummary(
        arm=arm,
...
def _three_summaries_for_arm_window(
    ...
    obs_table = {
        v0_53k_audit.TICK_50: v0_53k_audit.PRIMARY_OBSERVABLES_TICK50,
        v0_53k_audit.TICK_100: v0_53k_audit.PRIMARY_OBSERVABLES_TICK100,
        v0_53k_audit.TICK_200: v0_53k_audit.PRIMARY_OBSERVABLES_TICK200,
        v0_53k_audit.TICK_400: v0_53k_audit.PRIMARY_OBSERVABLES_TICK400,
    }
...
def _zero_drift_bridge_re_anchor() -> list[object]:
    return [
        v0_53k_audit.BridgeReAnchorRow(
            label=label,
            observable=obs,
        ...
        for (label, obs), ref in v0_53k_audit.V048_PUBLISHED_SIGNED_D.items()
    ]
...
def _green_d_anchor_kwargs() -> dict[str, object]:
    ...
    return {
        "d_reachability_tick400": v0_53k_audit.D_TIER3_REACHABILITY_LOCKED,
        "d_tick400_subverdict": v0_53k_audit.SUBVERDICT_D_FOOD_NEAR2_TICK400_PRESENT,
        "d_tick400_signed_d": dict(v0_53k_audit.D_TIER3_ANCHOR_PUBLISHED),
    }


def _c_tick400_subverdict_for_kind(kind: str) -> str:
    table = {
        "PRESENT": v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        "PARTIAL": v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PARTIAL,
        "NOT_FOUND": v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_NOT_FOUND,
        "OPPOSITE": v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE,
    }
    return table[kind]
...
def test_paired_d_function_reproduces_hand_computed_signed_d_on_fixture_and_tier1_v048_constants_and_tier3_v053i_constants():  # noqa: E501
    ...
    derived_d = v0_53k_audit._paired_cohens_d(deltas)
    ...
    assert pinned_v048 == v0_53k_audit.V048_PUBLISHED_SIGNED_D
    ...
    assert pinned_v053i_d_anchor == v0_53k_audit.D_TIER3_ANCHOR_PUBLISHED
    expected_rounded = {
    ...
    assert v0_53k_audit.D_TIER3_REACHABILITY_LOCKED == 35.0 / 64.0
    assert v0_53k_audit.D_TIER3_PAIRED_D_TOLERANCE == 1e-3
...
def test_a_null_v025_corpus_a_share_h8_re_anchors_v042_v044_v045():
    clean = [
        v0_53k_audit.ReAnchorRow(
            arm=v0_53k_audit.ARM_A_NULL_V025,
            version=ver,
            hazard=8,
    ...
    rollup, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
    ...
    assert rollup == v0_53k_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_SENSOR_RADIUS_8

    drifted = list(clean)
    drifted[1] = v0_53k_audit.ReAnchorRow(
        arm=v0_53k_audit.ARM_A_NULL_V025,
        version="v0.44",
        hazard=8,
        n_runs_contributing=8,
    ...
    rollup_d, phrase_d = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
    ...
    assert rollup_d == v0_53k_audit.ROLLUP_CORPUS_DRIFT_HALT
...
def test_arm_a_null_v025_uses_tight_gradient_layout_default_body_config_and_n_ticks_200_with_explicit_geometry_asserts():  # noqa: E501
    layout = v0_53k_audit._layout_for_arm(v0_53k_audit.ARM_A_NULL_V025)
    ...
    assert v0_53k_audit.LAYOUT_NAME_BY_ARM[v0_53k_audit.ARM_A_NULL_V025] == "tight_gradient"
    assert v0_53k_audit._body_config_for_arm(v0_53k_audit.ARM_A_NULL_V025) is None
    assert (
        v0_53k_audit.BODY_BASE_METABOLIC_COST_BY_ARM[v0_53k_audit.ARM_A_NULL_V025]
        == v0_53k_audit.V0_25_BODY_BASE_METABOLIC_COST
        == 0.25
    )
    assert v0_53k_audit.N_TICKS_BY_ARM[v0_53k_audit.ARM_A_NULL_V025] == 200
    assert (
        v0_53k_audit.WINDOWS_BY_ARM[v0_53k_audit.ARM_A_NULL_V025]
        == v0_53k_audit.WINDOWS_AB
        == (50, 100, 200)
    )
    assert (
        v0_53k_audit.BODY_EFFECTIVE_SENSOR_RADIUS_OVERRIDE_BY_ARM[v0_53k_audit.ARM_A_NULL_V025]
        is None
    )
...
def test_arm_b_widened_v025_uses_widened_gradient_layout_default_body_config_and_n_ticks_200_with_explicit_geometry_asserts():  # noqa: E501
    layout = v0_53k_audit._layout_for_arm(v0_53k_audit.ARM_B_WIDENED_V025)
    assert layout.safe_x_min == 0
    ...
    assert v0_53k_audit.LAYOUT_NAME_BY_ARM[v0_53k_audit.ARM_B_WIDENED_V025] == "widened_gradient"
    assert v0_53k_audit._body_config_for_arm(v0_53k_audit.ARM_B_WIDENED_V025) is None
    assert (
        v0_53k_audit.BODY_BASE_METABOLIC_COST_BY_ARM[v0_53k_audit.ARM_B_WIDENED_V025]
        == v0_53k_audit.V0_25_BODY_BASE_METABOLIC_COST
        == 0.25
    )
    assert v0_53k_audit.N_TICKS_BY_ARM[v0_53k_audit.ARM_B_WIDENED_V025] == 200
    assert (
        v0_53k_audit.WINDOWS_BY_ARM[v0_53k_audit.ARM_B_WIDENED_V025]
        == v0_53k_audit.WINDOWS_AB
        == (50, 100, 200)
    )
    assert (
        v0_53k_audit.BODY_EFFECTIVE_SENSOR_RADIUS_OVERRIDE_BY_ARM[v0_53k_audit.ARM_B_WIDENED_V025]
        is None
    )


# ---------------------------------------------------------------------------
# Test 5 — Arm C uses FOOD_NEAR1 layout, combined body_config WITH
# effective_sensor_radius_override=8 (NEW perception assert), AND n_ticks=400.
# ---------------------------------------------------------------------------


def test_arm_c_widened_food_near1_combined_sr8_N400_uses_food_near1_layout_combined_body_config_with_sensor_override_8_and_n_ticks_400_with_explicit_geometry_and_perception_asserts(  # noqa: E501, N802
    tmp_path,
):
    arm_c = v0_53k_audit.ARM_C_WIDENED_FOOD_NEAR1_COMBINED_SR8_N400

    bc_c = v0_53k_audit._body_config_for_arm(arm_c)
    assert isinstance(bc_c, BodyConfig)
    assert bc_c.starting_energy == 100.0
    assert bc_c.base_metabolic_cost == 0.10
    # NEW perception assert (the only structural delta in C body_config vs v0.53j).
    assert bc_c.effective_sensor_radius_override == 8
    ...
    assert isinstance(v0_53k_audit.FOOD_NEAR1_LAYOUT, ChamberLayout)
    fn1 = v0_53k_audit.FOOD_NEAR1_LAYOUT
    ...
    assert v0_53k_audit.N_TICKS_BY_ARM[arm_c] == 400
    assert v0_53k_audit.BODY_EFFECTIVE_SENSOR_RADIUS_OVERRIDE_BY_ARM[arm_c] == 8

    seed = 41
    cap_c = v0_53k_audit._run_one_arm(
    ...
    assert cap_c.body_effective_sensor_radius_override == 8
    # Pre-reg test #5 locks `final_tick_count == 400`. Empirically the chamber
    # halts on full extinction; v0.53j's test #5 used `<= 400` for the same
    # reason. We mirror v0.53j's precedent: enforce the configured horizon
    # cap while permitting deterministic early-extinction.
    assert cap_c.final_tick_count <= 400


# ---------------------------------------------------------------------------
# Test 6 — Arm D uses FOOD_NEAR2 layout, combined body_config with NO
# effective_sensor_radius_override (NEW negative perception assert), AND
# n_ticks=400.
# ---------------------------------------------------------------------------


def test_arm_d_widened_food_near2_combined_N400_uses_food_near2_layout_combined_body_config_no_sensor_override_and_n_ticks_400_with_explicit_geometry_and_perception_asserts(  # noqa: E501, N802
    tmp_path,
):
    arm_d = v0_53k_audit.ARM_D_WIDENED_FOOD_NEAR2_COMBINED_N400

    bc_d = v0_53k_audit._body_config_for_arm(arm_d)
    assert isinstance(bc_d, BodyConfig)
    assert bc_d.starting_energy == 100.0
    assert bc_d.base_metabolic_cost == 0.10
    # NEW negative perception assert (D matches v0.53i/j default — no override).
    assert bc_d.effective_sensor_radius_override is None

    # Module-level layout constant exposed and constructed script-local.
    assert isinstance(v0_53k_audit.FOOD_NEAR2_LAYOUT, ChamberLayout)
    fn2 = v0_53k_audit.FOOD_NEAR2_LAYOUT
    assert fn2.food_x_min == 8
    assert fn2.food_x_max == 12
    assert fn2.width == 13

    assert v0_53k_audit.N_TICKS_BY_ARM[arm_d] == 400
    assert v0_53k_audit.BODY_EFFECTIVE_SENSOR_RADIUS_OVERRIDE_BY_ARM[arm_d] is None

    seed = 41
    cap_d = v0_53k_audit._run_one_arm(
    ...
    for rec in cap_d.founder_records:
        ...
        assert rec.founder_body_starting_energy_tick0 == 100.0
        assert rec.founder_body_base_metabolic_cost_tick0 == 0.10
        # NEW negative perception founder assert.
    ...
    # See test #5 comment: pre-reg locks `==400`; v0.53j relaxed to `<=400`
    # under deterministic early-extinction. Mirror v0.53j precedent here.
    assert cap_d.final_tick_count <= 400


# ---------------------------------------------------------------------------
# Test 7 — Cross-arm perception contrast: C has override=8, D has no override,
# layouts differ by food_x_min (this absorbs v0.53j's food_x_min contrast).
# ---------------------------------------------------------------------------


def test_cross_arm_perception_contrast_c_has_override_8_d_has_no_override_layouts_differ_by_food_x_min(  # noqa: E501
    tmp_path,
):
    seed = 41
    cap_c = v0_53k_audit._run_one_arm(
        arm=v0_53k_audit.ARM_C_WIDENED_FOOD_NEAR1_COMBINED_SR8_N400,
        version="v0.42",
        seed=seed,
        hazard=0,
        runs_root=tmp_path,
    ...
    cap_d = v0_53k_audit._run_one_arm(
        arm=v0_53k_audit.ARM_D_WIDENED_FOOD_NEAR2_COMBINED_N400,
        version="v0.42",
        seed=seed,
        hazard=0,
        runs_root=tmp_path,
    ...
    # Perception axis: the unique C/D differentiator beyond layout.
    assert cap_c.body_effective_sensor_radius_override == 8
    assert cap_d.body_effective_sensor_radius_override is None
...
# Bookkeeping only — v0.53k's verdict / anchor / locked phrases are not changed.
...
def test_no_src_modifications_compared_to_v0_53e_tip():
    ...
    for rel_path, expected_hash in V052B_TIP_SHA256.items():
        ...
        if actual_hash != expected_hash:
            raise AssertionError(
                "v0.53k is pre-registered to leave the science-core five files "
    ...
    if actual_chamber_hash != V053E_CHAMBER_DRIVER_SHA256:
        raise AssertionError(
            "v0.53k is pre-registered to leave the chamber driver byte-identical "
...
def test_label_a_high_sensor_radius_lineage_picks_correct_lineage():
    ...
    label = v0_53k_audit._select_sensor_radius_label(sensor_radius_by_lineage)
    assert label == 4

    sensor_tied = {0: 6, 1: 5, 2: 6, 3: 6, 4: 4}
    label_tied = v0_53k_audit._select_sensor_radius_label(sensor_tied)
    assert label_tied == 0


# ---------------------------------------------------------------------------
# Test 10 — Label B four variants three-tier tiebreak at each window.
# ---------------------------------------------------------------------------


def _build_capture_minimal(arm: str, n_ticks: int) -> object:
    layout = v0_53k_audit._layout_for_arm(arm)
    cap = v0_53k_audit._RunCapture(
        arm=arm,
        layout_name=v0_53k_audit.LAYOUT_NAME_BY_ARM[arm],
        ...
        body_starting_energy=v0_53k_audit.BODY_STARTING_ENERGY_BY_ARM[arm],
        body_base_metabolic_cost=v0_53k_audit.BODY_BASE_METABOLIC_COST_BY_ARM[arm],
        body_effective_sensor_radius_override=(
            v0_53k_audit.BODY_EFFECTIVE_SENSOR_RADIUS_OVERRIDE_BY_ARM[arm]
        ),
        n_ticks=n_ticks,
        version="v0.42",
        seed=41,
...
def test_label_b_four_variants_three_tier_tiebreak_at_each_window_with_pre400_c_and_d_only():
    ...
    assert v0_53k_audit._select_fraction_label(candidates_count_tiebreak) == 1

    candidates_min_lid = [(3, 0.5, 4), (1, 0.5, 4), (2, 0.5, 4)]
    assert v0_53k_audit._select_fraction_label(candidates_min_lid) == 1

    candidates_simple = [(0, 0.3, 5), (1, 0.7, 1), (2, 0.5, 3)]
    assert v0_53k_audit._select_fraction_label(candidates_simple) == 1

    assert v0_53k_audit._select_fraction_label([]) is None

    energy_threshold = 5.0
    min_age = 1
    all_lineages = [0, 1, 2]
    snaps = [
        v0_53k_audit._ReadinessSnapshot(agent_id=10, lineage_id=0, energy=10.0, age=2),
        v0_53k_audit._ReadinessSnapshot(agent_id=11, lineage_id=0, energy=4.0, age=2),
        v0_53k_audit._ReadinessSnapshot(agent_id=20, lineage_id=1, energy=10.0, age=2),
        v0_53k_audit._ReadinessSnapshot(agent_id=30, lineage_id=2, energy=10.0, age=2),
        v0_53k_audit._ReadinessSnapshot(agent_id=31, lineage_id=2, energy=10.0, age=2),
    ]
    selected_a, _, _, fr_a = v0_53k_audit._readiness_label_at_tick(
    ...
    cap_a = _build_capture_minimal(v0_53k_audit.ARM_A_NULL_V025, 200)
    cap_b = _build_capture_minimal(v0_53k_audit.ARM_B_WIDENED_V025, 200)
    cap_c = _build_capture_minimal(v0_53k_audit.ARM_C_WIDENED_FOOD_NEAR1_COMBINED_SR8_N400, 400)
    cap_d = _build_capture_minimal(v0_53k_audit.ARM_D_WIDENED_FOOD_NEAR2_COMBINED_N400, 400)
    rows_a = v0_53k_audit._aggregate_per_lineage(cap_a)
    rows_b = v0_53k_audit._aggregate_per_lineage(cap_b)
    rows_c = v0_53k_audit._aggregate_per_lineage(cap_c)
    rows_d = v0_53k_audit._aggregate_per_lineage(cap_d)
...
# ---------------------------------------------------------------------------
# Test 11 — pre400 window strictly extends pre200/pre100/pre50 on C AND D.
...
def _seed_pre_buckets(capture: object, event_ticks: list[int]) -> None:
    ...
    for tick_now in event_ticks:
        if tick_now <= v0_53k_audit.TICK_50:
        ...
        if tick_now <= v0_53k_audit.TICK_100:
        ...
        if tick_now <= v0_53k_audit.TICK_200:
        ...
        if tick_now <= v0_53k_audit.TICK_400:
...
def _build_capture_for_pre_extends(arm: str) -> object:
    layout = v0_53k_audit._layout_for_arm(arm)
    return v0_53k_audit._RunCapture(
        arm=arm,
        layout_name=v0_53k_audit.LAYOUT_NAME_BY_ARM[arm],
        safe_x_min=int(layout.safe_x_min),
        safe_x_max=int(layout.safe_x_max),
...
def test_pre400_window_strictly_extends_pre200_pre100_pre50_windows_on_c_and_d_arms():
    ...
    aid = 7
    cap_c = _build_capture_for_pre_extends(v0_53k_audit.ARM_C_WIDENED_FOOD_NEAR1_COMBINED_SR8_N400)
    cap_d = _build_capture_for_pre_extends(v0_53k_audit.ARM_D_WIDENED_FOOD_NEAR2_COMBINED_N400)
...
def test_subverdict_present_requires_two_thirds_firing_cells_with_nan_treated_as_non_firing_strict():  # noqa: E501
    arm = v0_53k_audit.ARM_C_WIDENED_FOOD_NEAR1_COMBINED_SR8_N400
    window = v0_53k_audit.TICK_400

    summaries_a_2firing_1nan = _three_summaries_for_arm_window(
        arm, window, (+0.6, +0.6, float("nan")), v0_53k_audit.LABEL_A_NAME
    )
    summaries_b_clean = _three_summaries_for_arm_window(
        arm, window, (+0.6, +0.6, -0.6), v0_53k_audit.LABEL_B_TICK400_NAME
    )
    assert (
        v0_53k_audit._arm_subverdict_at_window(
            arm, window, summaries_a_2firing_1nan, summaries_b_clean
        )
        == v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT
    )

    summaries_a_1firing_2nan = _three_summaries_for_arm_window(
        arm, window, (+0.6, float("nan"), float("nan")), v0_53k_audit.LABEL_A_NAME
    )
    assert (
        v0_53k_audit._arm_subverdict_at_window(
            arm, window, summaries_a_1firing_2nan, summaries_b_clean
        )
        == v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PARTIAL
    )

    summaries_a_all_nan = _three_summaries_for_arm_window(
        arm, window, (float("nan"), float("nan"), float("nan")), v0_53k_audit.LABEL_A_NAME
    )
    assert (
        v0_53k_audit._arm_subverdict_at_window(arm, window, summaries_a_all_nan, summaries_b_clean)
        == v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PARTIAL
    )
    ...
    summaries_b_all_nan = _three_summaries_for_arm_window(
        ...
        v0_53k_audit.LABEL_B_TICK400_NAME,
    )
    assert (
        v0_53k_audit._arm_subverdict_at_window(
            arm, window, summaries_a_all_nan, summaries_b_all_nan
        )
        == v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_NOT_FOUND
    )


# ---------------------------------------------------------------------------
# Test 13 — Priority 3 PERCEPTION_OPPOSITE_SIGN_HALT is REACHABILITY-GATED on
# C tick-400. Three branches.
# ---------------------------------------------------------------------------


def test_priority_3_perception_opposite_sign_halt_is_reachability_gated_on_c_tick_400(tmp_path):
    bridge_clean = _zero_drift_bridge_re_anchor()
    arm_c = v0_53k_audit.ARM_C_WIDENED_FOOD_NEAR1_COMBINED_SR8_N400
    window = v0_53k_audit.TICK_400

    summaries_a_wrong = _three_summaries_for_arm_window(
        arm_c, window, (+0.6, +0.6, -0.7), v0_53k_audit.LABEL_A_NAME
    )
    summaries_b_clean_above = _three_summaries_for_arm_window(
        arm_c, window, (+0.6, +0.6, +0.5), v0_53k_audit.LABEL_B_TICK400_NAME
    )
    c_sub_opposite = v0_53k_audit._arm_subverdict_at_window(
        arm_c, window, summaries_a_wrong, summaries_b_clean_above
    )
    assert c_sub_opposite == v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE

    # Branch A: C reach = 0.30 + C OPPOSITE -> priority 3 fires.
    rollup_a, phrase_a = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
    ...
    assert rollup_a == v0_53k_audit.ROLLUP_PERCEPTION_OPPOSITE_SIGN_HALT
    ...
    rollup_b, phrase_b = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=c_sub_opposite,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_b != v0_53k_audit.ROLLUP_PERCEPTION_OPPOSITE_SIGN_HALT
    assert (
        rollup_b == v0_53k_audit.ROLLUP_WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_SENSOR_RADIUS_8
    )
    assert "the perception-only override `BodyConfig.effective_sensor_radius_override = 8`" in (
        phrase_b
    )

    wrong_sign_cells = v0_53k_audit._collect_c_tick400_wrong_sign_cells(
    ...
    assert wsc.label == v0_53k_audit.LABEL_B_TICK400_NAME
    ...
    summaries_a_clean_present = _three_summaries_for_arm_window(
        arm_c, window, (+0.6, +0.6, -0.6), v0_53k_audit.LABEL_A_NAME
    )
    summaries_b_clean_present = _three_summaries_for_arm_window(
        arm_c, window, (+0.6, +0.6, -0.6), v0_53k_audit.LABEL_B_TICK400_NAME
    )
    c_sub_present = v0_53k_audit._arm_subverdict_at_window(
        arm_c, window, summaries_a_clean_present, summaries_b_clean_present
    )
    assert c_sub_present == v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT
    rollup_c, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
    ...
    assert rollup_c == v0_53k_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_SENSOR_RADIUS_8
    ...
    arms_for_window = {
        v0_53k_audit.TICK_50: v0_53k_audit.ARMS,
        v0_53k_audit.TICK_100: v0_53k_audit.ARMS,
        v0_53k_audit.TICK_200: v0_53k_audit.ARMS,
        v0_53k_audit.TICK_400: (
            v0_53k_audit.ARM_C_WIDENED_FOOD_NEAR1_COMBINED_SR8_N400,
            v0_53k_audit.ARM_D_WIDENED_FOOD_NEAR2_COMBINED_N400,
        ),
    }
    ...
    reachability_by_window[v0_53k_audit.TICK_200][v0_53k_audit.ARM_B_WIDENED_V025] = (0.0, 64)
    reachability_by_window[v0_53k_audit.TICK_400][arm_c] = (0.20, 64)
    reachability_by_window[v0_53k_audit.TICK_400][
        v0_53k_audit.ARM_D_WIDENED_FOOD_NEAR2_COMBINED_N400
    ] = (v0_53k_audit.D_TIER3_REACHABILITY_LOCKED, 64)

    summaries_by_window = {
        v0_53k_audit.TICK_50: [],
        v0_53k_audit.TICK_100: [],
        v0_53k_audit.TICK_200: [],
        v0_53k_audit.TICK_400: list(summaries_a_wrong) + list(summaries_b_clean_above),
    }
    d_tier3_anchor_rows = [
        v0_53k_audit.DTier3AnchorRow(
            label=label,
            observable=obs,
            published_signed_d=ref,
            derived_signed_d=ref,
        ...
        for (label, obs), ref in v0_53k_audit.D_TIER3_ANCHOR_PUBLISHED.items()
    ]
    v0_53k_audit._write_audit_summary_csv(
        summaries_by_window,
        [],
        [],
        v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        {},
        c_sub_opposite,
        v0_53k_audit.SUBVERDICT_D_FOOD_NEAR2_TICK400_PRESENT,
        d_tier3_anchor_rows,
        v0_53k_audit.D_TIER3_REACHABILITY_LOCKED,
...
def test_b_widened_v025_categorical_anchor_at_tick_200_and_d_food_near2_positive_anchor_at_tick_400():  # noqa: E501
    ...
    rollup_clean, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_clean == v0_53k_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_SENSOR_RADIUS_8

    one_sixty_fourth = 1.0 / 64.0

    # Branch 2: Tier-2 broken (B reach = 1/64) -> ANCHOR_REPLICATION_HALT.
    rollup_b_drift, phrase_b_drift = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_b_drift == v0_53k_audit.ROLLUP_ANCHOR_REPLICATION_HALT
    assert "B_widened_V0_25" in phrase_b_drift or "0/64" in phrase_b_drift
    assert "v0.53k" in phrase_b_drift
    ...
    rollup_d_reach, phrase_d_reach = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_d_reach == v0_53k_audit.ROLLUP_ANCHOR_REPLICATION_HALT
    ...
    d_kwargs_sub_halt["d_tick400_subverdict"] = v0_53k_audit.SUBVERDICT_D_FOOD_NEAR2_TICK400_PARTIAL
    rollup_d_sub, phrase_d_sub = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_d_sub == v0_53k_audit.ROLLUP_ANCHOR_REPLICATION_HALT
    ...
    drifted_signed_d = dict(v0_53k_audit.D_TIER3_ANCHOR_PUBLISHED)
    drift_key = (v0_53k_audit.LABEL_A_NAME, "pre400_food_events_count")
    drifted_signed_d[drift_key] = drifted_signed_d[drift_key] + 0.005
    d_kwargs_pd_halt["d_tick400_signed_d"] = drifted_signed_d
    rollup_d_pd, phrase_d_pd = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_d_pd == v0_53k_audit.ROLLUP_ANCHOR_REPLICATION_HALT
...
def test_c_tick_400_reachability_threshold_partition():
    ...
    for c_kind in ("PRESENT", "PARTIAL", "NOT_FOUND"):
        ...
        assert (
            rollup == v0_53k_audit.ROLLUP_WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_SENSOR_RADIUS_8
        )

    rollup_present, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_present == v0_53k_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_SENSOR_RADIUS_8
    ...
    for c_kind in ("PARTIAL", "NOT_FOUND"):
        ...
        assert rollup == v0_53k_audit.ROLLUP_WIDENED_BRIDGE_PARTIALLY_RESCUED_BY_SENSOR_RADIUS_8


# ---------------------------------------------------------------------------
# Test 16 — Rollup locked phrases fire verbatim AND priority cascade +
# partition exhaustiveness. v0.53k locked phrases reference the FULL
# predecessor stack (v0.53c..v0.53j) verbatim where the pre-reg locks.
# ---------------------------------------------------------------------------
...
def test_rollup_locked_phrases_fire_verbatim_and_priority_cascade_partition_total():  # noqa: PLR0915
    ...
    bridge_drift[0] = v0_53k_audit.BridgeReAnchorRow(
    ...
    # Priority 3 PERCEPTION_OPPOSITE_SIGN_HALT (reachability-gated on tick-400).
    _, phrase_p3 = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
        b_widened_v025_reachability_tick200=0.0,
        c_reachability_tick400=0.50,
    ...
    assert "perception-only intervention (`BodyConfig.effective_sensor_radius_override = 8`)" in (
        phrase_p3
    )

    # Priority 4 RESCUED.
    _, phrase_rescued = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert "the minimum east-ray reach from `spawn_x=1` to FOOD_NEAR1's `food_x_min=9`" in (
        phrase_rescued
    )
    assert "metabolic cost UNAFFECTED per the override's information-channel-only contract" in (
        phrase_rescued
    )
    assert (
        "The v0.53j FOOD_NEAR1/FOOD_NEAR2 boundary is **consistent with sensor-reach being a "
        "binding constraint** under the tested envelope"
    ) in phrase_rescued
    ...
    _, phrase_below = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_PRESENT,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert (
        "The v0.53j FOOD_NEAR1/FOOD_NEAR2 boundary is **NOT explained by sensor-reach alone** "
        "under the tested envelope"
    ) in phrase_below
    assert (
        "v0.53l (or later) candidates shift toward policy / hazard-avoidance / "
        "movement-mechanics probes"
    ) in phrase_below
    for tag in (
        "WIDENED_BELOW_REACHABILITY_THRESHOLD_AT_TICK_200",
        "WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_RELAXED_INFLUX",
    ...
    _, phrase_partial = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_NOT_FOUND,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
        b_widened_v025_reachability_tick200=0.0,
        c_reachability_tick400=0.30,
    ...
    rollup_1, phrase_1 = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_NOT_FOUND,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE,
    ...
    assert rollup_1 == v0_53k_audit.ROLLUP_CORPUS_DRIFT_HALT
    assert "v0.42" in phrase_1

    rollup_2a, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_drift,
    ...
    assert rollup_2a == v0_53k_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    rollup_2b, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_NOT_FOUND,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_2b == v0_53k_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    rollup_2c, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_2d == v0_53k_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    # 2.e: D sub-verdict != PRESENT -> ANCHOR_REPLICATION_HALT.
    d_kwargs_2e = _green_d_anchor_kwargs()
    d_kwargs_2e["d_tick400_subverdict"] = v0_53k_audit.SUBVERDICT_D_FOOD_NEAR2_TICK400_PARTIAL
    rollup_2e, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_2f == v0_53k_audit.ROLLUP_ANCHOR_REPLICATION_HALT

    rollup_3, _ = v0_53k_audit._evaluate_rollup(
        a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
        c_tick400_subverdict=v0_53k_audit.SUBVERDICT_C_FOOD_NEAR1_TICK400_OPPOSITE,
        corpus_re_anchor=[],
        bridge_re_anchor=bridge_clean,
    ...
    assert rollup_3 == v0_53k_audit.ROLLUP_PERCEPTION_OPPOSITE_SIGN_HALT
    ...
    for c_kind in sub_kinds_all:
        ...
        rollup_above, _ = v0_53k_audit._evaluate_rollup(
            a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
            c_tick400_subverdict=c_sub,
            corpus_re_anchor=[],
            bridge_re_anchor=bridge_clean,
        ...
        rollup_below, _ = v0_53k_audit._evaluate_rollup(
            a_null_tick50_subverdict=v0_53k_audit.SUBVERDICT_A_NULL_V025_TICK50_PRESENT,
            c_tick400_subverdict=c_sub,
            corpus_re_anchor=[],
            bridge_re_anchor=bridge_clean,
    ...
    rescued = v0_53k_audit.ROLLUP_WIDENED_BRIDGE_RESCUED_BY_SENSOR_RADIUS_8
    partial_outcome = v0_53k_audit.ROLLUP_WIDENED_BRIDGE_PARTIALLY_RESCUED_BY_SENSOR_RADIUS_8
    below = v0_53k_audit.ROLLUP_WIDENED_BELOW_REACHABILITY_THRESHOLD_UNDER_SENSOR_RADIUS_8
    perception_opp = v0_53k_audit.ROLLUP_PERCEPTION_OPPOSITE_SIGN_HALT
